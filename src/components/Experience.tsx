...
const Experience: React.FC = () => {
  ...
  return (
    <section id="experience" className="py-20 bg-gradient-to-br from-cyan-50/80 via-white/80 to-blue-50/80 dark:from-gray-900/80 dark:via-gray-800/80 dark:to-cyan-900/80">
