          ...
          {categories.map((category, index) => {
            ...
            return (
              <motion.div
                ...
                className="px-4 py-2 bg-white dark:bg-gray-700 rounded-full shadow-md hover:shadow-lg transition-all duration-200"
              >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {certifications.map((cert, index) => (
            <motion.div
              ...
              className="group bg-white dark:bg-gray-900 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 dark:border-gray-700"
            >
              {/* Header Gradient */}
              ...
              <div className="p-6">
                ...
                {/* Certificate Icon */}
                <div className={`inline-flex p-3 rounded-xl bg-gradient-to-r ${cert.color} mb-4 group-hover:scale-110 transition-transform duration-200`}>
                  <Award className="w-6 h-6 text-white" />
                </div>

                {/* Title */}
                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-200 leading-tight">
                  {cert.title}
                </h3>
